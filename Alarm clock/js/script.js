...
function runAlarm() {
  ...
  alarms.forEach((form) => {
    console.log(form.lastChild.innerHTML);
    ...
    if (
      ...
      openBtn.classList.add("dont-show");
      settingsArea.classList.add("dont-show");
      //play the sound from the beginning everytime
